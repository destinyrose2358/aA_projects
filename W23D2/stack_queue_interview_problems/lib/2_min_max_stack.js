...
class MinMaxStack {
    ...
    push(val) {
        ...
        if (!this.top) {
            ...
            this.top = newNode;
            this.top.next = temp;
            this.minimum = this.minimum.value > newNode.value ? newNode : this.minimum;
            this.maximum = this.maximum.value < newNode.value ? newNode : this.maximum;
        }
        return ++this.length;
    }
